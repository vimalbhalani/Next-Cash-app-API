...
export const PromotionRule = () => {
    ...
    return (
        <>
            ...
            <div className="relative border p-8 rounded-lg bg-white text-black text-center font-medium -top-10 z-[-1]">You must play X5 of the loaded amount to withdraw.<br/>
                {'('}Ex. 10{'>'}50, 50{'>'}250{')'}<br />
